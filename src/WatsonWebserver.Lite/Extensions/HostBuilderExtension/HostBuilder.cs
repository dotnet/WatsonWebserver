namespace WatsonWebserver.Lite.Extensions.HostBuilderExtension
{
    ...
    public class HostBuilder : IHostBuilder<HostBuilder, Func<HttpContextBase, Task>>
    {
        ...
        /// Webserver.
        /// </summary>
        public WebserverLite Server
        {
            get
            {
                if (_Server == null)
                {
                    _Server = new WebserverLite(_Settings, _DefaultRoute);
                    return _Server;
                }
                return _Server;
            }
        ...
        private WebserverLite _Server = null;
        ...
        public HostBuilder(string hostname, int port, bool ssl, Func<HttpContextBase, Task> defaultRoute)
        {
            ...
            _Server = new WebserverLite(_Settings, defaultRoute);
